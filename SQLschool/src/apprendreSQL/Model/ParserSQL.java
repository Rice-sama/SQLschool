...
public  class ParserSQL implements ParserSQLConstants {
	...
	public ArrayList<String> idTokens = new ArrayList<String>();
	
/* Grammar */
  final public int sqlStmtList() throws ParseException {
	    int stmtType = sqlStmt();
	    jj_consume_token(SEMICOLON);
	    return stmtType;
	  }

  final public int sqlStmt() throws ParseException {
	int stmtType = EOF;
...
// to avoid left recursion.
  ...
  private Token jj_consume_token(int kind) throws ParseException {
    ...
    if (token.kind == kind) {
      ...
      System.out.println(" token :"+ token + " -> : "+ ParserSQLConstants.tokenImage[kind]);
      return token;
    }
    token = oldToken;
    jj_kind = kind;
