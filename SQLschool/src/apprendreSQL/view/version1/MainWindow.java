...
public class MainWindow extends JFrame implements ActionListener {
	...
	private void init(EventManager manager) {
		...
		tabs.add("Sch�ma relationnel", diagramsView);
	...
	protected JMenuBar createMenuBar() {
		...
		JMenuItem helpMenuItem = new JMenuItem("� propos de SQLschool");
		...
		helpMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(MainWindow.this, viewPort, "� propos de SQLschool",
